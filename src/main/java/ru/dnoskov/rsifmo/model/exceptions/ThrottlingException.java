package ru.dnoskov.rsifmo.model.exceptions;
...
public class ThrottlingException extends Exception {
	...
	public ThrottlingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
